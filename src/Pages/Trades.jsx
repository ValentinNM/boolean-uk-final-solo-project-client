...
export default function Trades() {
  ...
  const handleSort = (e, symbol) => {
    ...
    if (type === "checkbox") {
      if (checked) {// handle checked

        const filtered = allAssets.filter((asset) => asset.assetSymbol === symbol); // add one

        setFilterBySymbol(filterBySymbol.concat(filtered.map((asset) => asset.assetSymbol))); // concat || add next obj to array
      } else { // handle unchecked

        setFilterBySymbol(filterBySymbol.filter((assetSymbol) => assetSymbol !== symbol));
      }
    }
  };
        ...
        <aside className="trades-aside">
          <div>
            ...
            <div>
              ...
              <select name="dropdown" onChange={handleSort}>
          ...
          <div className="assets-filter">
            ...
            <button type="button" name="clear" className="clear-all">Clear All</button>
          </div>
        </aside>
      </section>
    </div>
